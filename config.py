...
BOT_TOKEN = "7326193661:AAHQZPvM2zBnJl-g0CPT_QWTzhvnckK5Q4A"

# Списки ID пользователей Telegram, имеющих роли Админа и Бухгалтера
ADMIN_IDS = [1037664248, 789068055, 6981724635, 5942351384, 756383028, 7762892591, 5424756440]
ACCOUNTANT_IDS = [789068055, 1037664248, 6981724635, 5942351384, 756383028, 7651856323, 940696947]
MASTER_IDS = [1037664248, 789068055, 6981724635, 5942351384, 756383028, 7553162595, 5191119160]
